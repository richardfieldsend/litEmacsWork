* Config.org: Configuring Emacs using Org-Mode and Babel.
** Introduction.
   When I want to write text on a Linux system my preferred editor is
undoubtedly Emacs, and every user of Emacs spends an inordinate length
of time tweaking their setup.

In the past I used techniques like downloading and unpacking the code
for various plugins into a defined folder.
...
***** Quickly find recently used files.
#+begin_src emacs-lisp
    (use-package recentf
      :config
...
#+end_src
***** Dashboard  - nice start up screen
Not sure whether I'll keep this, we'll see. Info about this
...
#+begin_src emacs-lisp
  ...
  (setq user-mail-address "richardfieldsend@gmail.com")
#+end_src
**** Emacs Server.
...
**** Size indication mode - how big is the file?
Display how large the file you are editing is in the information bar
